...
const Footer = () => {
    ...
    <footer>
        ...
        <a className="elem-foot" href="https://www.facebook.com" target="_blank" rel="noopener">
            <img src={Fb} width="25" height="25" alt="Facebook" />
        </a>
        <a className="elem-foot" href="https://www.instagram.com" target="_blank" rel="noopener">
